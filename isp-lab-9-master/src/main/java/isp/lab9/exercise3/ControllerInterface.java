...
public interface ControllerInterface {
     ...
     * If {@link ControllerInterface#MASTER_KEY} is used as input value,
     * number of retries will be reset to 0 and door will be locked / unlocked based on its current state
     *
     * @param pin - pin value
     ...
     * When tenant with this name already exists, 
     * {@link TenantAlreadyExistsException} will be thrown
     *
