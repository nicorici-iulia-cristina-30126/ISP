...
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        acc[0] = new Account("Iulia", 1233, card1); 
        Card card2 = new Card(card1.getPin(),"123");
        acc[1] = new Account("Iulia", 400, card2);
        Card card3 = new Card(card1.getPin(),"234");
        acc[2] = new Account("Iulia", 0, card3);
        Card card4 = new Card(card1.getPin(),"345");
        acc[3] = new Account(card1.getPin(), 20, card4);
        Card card5 = new Card(card1.getPin(),"3456");
        acc[4] = new Account("Iulia", 20000, card5);
        Card card6 = new Card(card1.getPin(),"456");
        acc[5] = new Account("Iulia", 121, card6);
        Card card7 = new Card(card1.getPin(),"567");
        acc[6] = new Account("Iulia", 90, card7);
        Card card8 = new Card(card1.getPin(),"890");
        acc[7] = new Account("Iulia", 12, card8);
        Card card9 = new Card(card1.getPin(),"901");
        acc[8] = new Account("Iulia", 87, card9);
        Card card10 = new Card(card1.getPin(),"912");
        acc[9] = new Account("Iulia", 947, card10);
        Bank bank = new Bank(acc); //transimt the accounts in the bank 
